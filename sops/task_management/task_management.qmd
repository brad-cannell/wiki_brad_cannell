# Task Management {sec-task-management}

```{r}
#| label: fig-task-management-header-img
#| echo: false
#| fig-cap: |
#|   Header image: Task Management SOP
#| fig-alt: |
#|   An decorative image about task management.

knitr::include_graphics("https://miro.medium.com/v2/resize:fit:1000/1*8G1vA7egoxrL4Bb7RAgnPQ.jpeg")
```
...
(This is from SharePoint and can probably be deleted.)
